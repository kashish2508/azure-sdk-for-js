...
Add the broken links into [`eng/ignore-links.txt`](../eng/ignore-links.txt) to bypass this verification, or update the broken links to valid ones. See [example PR here](https://github.com/Azure/azure-sdk-for-js/pull/23429/commits/1a7b74c4bdad27e423a355a4c7f3dde4ac3c83bc).


# Check spelling (cspell)

For a new service this error is common. Fix the spelling in code or markdown, or add approved terms to [`.vscode/cspell.json`](../.vscode/cspell.json). See an example in [devcenter PR](https://github.com/chrissmiller/azure-sdk-for-js/commit/ef18dccae59e98185e3854f8b087230b65735744).
