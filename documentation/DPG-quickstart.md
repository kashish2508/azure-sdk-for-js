...
- Install tsp-client dependencies with `pnpm --dir eng/common/tsp-client install`
...
2. **Generate code**
    ...
    **Re-generate an existing TypeScript DPG library**
    ...
    ---  
    **NOTE**
    The version of typespec-ts is configured in [emitter-package.json](https://github.com/Azure/azure-sdk-for-js/blob/main/eng/emitter-package.json). Change it locally if you need to test a different emitter version.
