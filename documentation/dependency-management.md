...
The outputs below use `npm` because this guide is about applications that consume Azure SDK packages. Repository contributors should continue to use `pnpm` for work inside `azure-sdk-for-js`.
